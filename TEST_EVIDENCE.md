...
Current privacy-safe evidence does not justify adding separate Home Depot / Home Depot Canada or Costco source categories yet. Treat those merchants as generic merchant receipts unless repeated privacy-safe summaries show source-specific parser gaps that synthetic fixtures can cover.
