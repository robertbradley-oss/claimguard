export const analyzerTuningSummary = {
  ...
  receiptStructure: [
    ...
    },
    {
      ...
      value: "invoice/sold-by/billing/promotion",
      detail: "Printable invoice and order-detail wording is surfaced as purchase-matching context, including Subscribe & Save or promo layouts.",
    },
    {
