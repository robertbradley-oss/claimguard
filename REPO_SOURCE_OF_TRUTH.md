...
- The next safest move is a docs-only Phase 2.7.5 workflow/caller boundary opt-in design, only with explicit Robert approval. Do not wire the wrapper into live callers or change runtime/UI/upload/report behavior without explicit approval.
