...
- The next safe task is a review-only Phase 3.3 post-push QA/source-of-truth closeout, or a separately approved Phase 3.4 planning/design task. Do not add persistence or deeper workflow behavior yet.
