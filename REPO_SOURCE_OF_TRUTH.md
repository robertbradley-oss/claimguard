...
- The next safest move is review and, if approved, commit the docs-only Phase 2.8.1 plan. Do not wire the wrapper into live callers or change runtime/UI/upload/report behavior without explicit approval.
