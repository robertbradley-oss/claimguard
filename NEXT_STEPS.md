...
1. Run a Phase 2.4.1 post-fix closeout review after the top-level evidence-type mismatch blocker patch, with no new implementation unless Robert explicitly opens another slice.
