...
```text
/claimguardagent review and, if approved, commit the docs-only Phase 3.1 Case Review Command Center design concept; do not edit implementation files, add routes/components, wire ClaimReviewWorkflow, add live unsupported-evidence UI, route ProductPhotoReviewPanel, change receipt behavior, connect providers/storage/integrations/case queues/OCR/metadata, deploy, or push
```
