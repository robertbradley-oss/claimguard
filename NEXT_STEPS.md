...
```text
/claimguardagent prepare Phase 4.19 OpenAI Vision sandbox planning only: define sandbox goals, privacy/retention questions, provider-boundary risks, route/upload stop conditions, and receipt-regression gates for a possible future vision sandbox; do not add SDKs/env vars/providers/uploads/storage/persistence/UI/live analyzer wiring, do not process real evidence, and do not start live AI/Vision/photo analysis
```
