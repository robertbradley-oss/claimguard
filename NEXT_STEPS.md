...
```text
/claimguardagent prepare Phase 4.20 OpenAI Vision sandbox prompt/output contract planning only: define the exact future sandbox prompt rules, structured output fields, safety refusals, privacy flags, timeout/cost metadata, and probe gates; do not add SDKs/env vars/providers/uploads/storage/persistence/UI/live analyzer wiring, do not process real evidence, do not change existing routes, and do not start live AI/Vision/photo analysis
```
