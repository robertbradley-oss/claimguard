...
- The next safe task is Phase 4.8 route hardening and developer-only fixture test documentation, or Phase 4.8 provider-selection planning and live-provider prerequisite review. Live OCR/provider work remains blocked unless Robert explicitly opens a named live/provider implementation slice.
